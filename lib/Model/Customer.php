...
'unique_user_id' => 'setUniqueUserId',
...
'country' => 'getCountry'    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['unique_user_id'] = isset($data['unique_user_id']) ? $data['unique_user_id'] : null;
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['unique_user_id'] === null) {
            $invalidProperties[] = "'unique_user_id' can't be null";
        }
     ...
     * Sets customer_id
     *
     * @param string $customer_id Unique technical key of a customer
     *
     * @return $this
     */
    ...
    {
        return $this->container['unique_user_id'];
    }

    /**
     * Sets unique_user_id
     *
     * @param string $unique_user_id Second identifier for the customer.
     *
     * @return $this
     */
    public function setUniqueUserId($unique_user_id)
    {
        $this->container['unique_user_id'] = $unique_user_id;
     ...
     * Sets country
     *
     * @param string $country The country in ISO-3166-1 Alpha-3 format. Please use countryCode from next versions
     *
     * @return $this
     */
